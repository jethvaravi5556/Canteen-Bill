...
<div class="main">
            <div class="wrapper">
                ...
                <ul>
                    ...
                    <li class="active"><a href="manage_admin.php">Admin</a></li>
...
<?php
	...
	{
		?>
		<h2 align="center" > Manage Admin<h2>
        <a href='add_admin.php'><input type='submit' value='+ add admin' class='admin'></a>
		...
		while($row=mysqli_fetch_array($cmd))
		{
			...
			<td>
            <a href='aupdate.php?aid=$row[aid]'><input type='submit' value='Update' class='update'></a>
            <a href='adelete.php?aid=$row[aid]'><input type='submit' value='Delete' class='delete'></a>
            </td>
			</tr>";
		}
	}
